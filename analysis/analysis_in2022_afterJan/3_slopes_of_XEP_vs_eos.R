...
#--------------------
load(paste0("./data/processed/preprocessed_phenos_andXEP_updated.RDA"))
...
ggsave(slopes_XEP_mean,width = 10,height=6,
       filename = paste0("./fig/Results_updated/using_filtered_data/ori_data/slopes_comparisons/sloeps_XEP_mean.png"))
ggsave(slopes_XEP_cum,width = 10,height=6,
       filename = paste0("./fig/Results_updated/using_filtered_data/ori_data/slopes_comparisons/sloeps_XEP_cum.png"))
