...
#save the data:
save(df.merge.final,file = paste0("./data/data_prep/Phenos_and_XEP/preprocessed_phenos_andXEP_updated.RDA"))
...
png(filename = paste("./manuscript/fig/Results_updated/using_filtered_data/uni_corrlation_PhenovsGPP_additional.png"),
...
ggsave(p_eos90_vs_XEP_GSLsol90,width = 10,height=10,
       filename = paste0("./manuscript/fig//Results_updated/using_filtered_data/ori_data/further_analysis/ori_GSLsol90_lm_plot.png"))
ggsave(p_eos50_vs_XEP_GSL9050,width = 10,height=10,
       filename = paste0("./manuscript/fig/Results_updated/using_filtered_data/ori_data/further_analysis/ori_GSL9050_lm_plot.png"))
ggsave(p_eos25_vs_XEP_GSL5025,width = 10,height=10,
       filename = paste0("./manuscript/fig/Results_updated/using_filtered_data/ori_data/further_analysis/ori_GSL5025_lm_plot.png"))
