...
#----------------
load(paste0("./data/data_prep/EC_data/flux_meteo_VIs_fromJiangong.rda"))
...
#save the MODIS VIs
save(df.VIs,file = paste0("./data/data_prep/MODIS_VIs_fromWalther2021.rda"))
...
#save the final data
save(df.final,file = paste0("./data/data_prep/df_GPP_Meteo_andVIs.rda"))
