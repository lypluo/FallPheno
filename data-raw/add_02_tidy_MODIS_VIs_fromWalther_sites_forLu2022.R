...
unique(df_merge$sitename)#the used sites are mainly located in Europe North America
...
sel_sites<-unique(df_merge$sitename)
df.VIs<-c()
...
#save the MODIS VIs
save(df.VIs,file = paste0("./data/data_prep/Add_analysis_based_Lu2022/MODIS_VIs_fromWalther2021_forLU2022_sites.rda"))
